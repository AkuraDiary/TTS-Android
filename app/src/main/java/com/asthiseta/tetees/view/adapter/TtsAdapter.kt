package com.asthiseta.tetees.view.adapter
...
class TtsAdapter : RecyclerView.Adapter<TtsAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(view: ViewHolder, i: Int) {
        ...
        if (tts.up != "") {
            view.txtItem.text = tts.up?.uppercase(Locale.getDefault())
        } else {
...
//            else view.txtItem.text = ""
        ...
        if (tts.clue != null) {
            ...
            if (bantuan) {
                if (tts.tts!!.uppercase(Locale.getDefault()) == tts.up?.uppercase(Locale.getDefault())) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    view.txtItem.setTextColor(view.itemView.context.getColor(R.color.white))
                } else {
                    view.txtItem.setTextColor(view.itemView.context.resources.getColor(R.color.white))
                }
                view.imgSalah.visibility = ImageView.GONE
            } else {
                view.txtItem.setTextColor(Color.BLACK)
